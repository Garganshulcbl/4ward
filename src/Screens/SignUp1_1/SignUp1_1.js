...
const SignUp1_1 = ({ navigation }) => {
    ...
    return (
        <View style={SignUp1_1Style.container}>
            <View style={SignUp1_1Style.topView}>
                ...
                <View>
                    <HeadText
                        mainText='Enter the 4-digit code sent to you at 875 364 8947'
                    />
                </View>
                <View>
                    <TouchableOpacity>
                ...
                <View style={SignUp1_1Style.textBoxView}>
                    <TextBox autoFocus={true} value={code1} onChangeText={addCode1} maxLength={1} />
            ...
            <View style={SignUp1_1Style.bottomView}>
                <View >
                    <Text style={SignUp1_1Style.resendText}>
                        Resend code in 0:14
                    </Text>
                    <View style={SignUp1_1Style.redBtnView}>
                        <RedButton onPress={() => { verifyBtn() }} redBtnText={'VERIFY'} />
                    </View>
                </View>
            </View>
        </View >
